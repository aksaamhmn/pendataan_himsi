...
export const metadata = {
  title: "Profile — Portal Mahasiswa PSDM HIMASI",
  description: "Halaman profil mahasiswa di portal PSDM HIMASI.",
};
...
export default async function MahasiswaProfilePage() {
  ...
  // Extract NRP dari email dummy (nrp@himasi.local → nrp)
  const email = user.email || "";
  const nrp = email.replace("@himasi.local", "");
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Portal pendataan mahasiswa PSDM HIMASI
        </p>
      </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">
                  Kamu sudah mengisi formulir pendataan PSDM HIMASI. Terima kasih atas partisipasimu!
                </p>
